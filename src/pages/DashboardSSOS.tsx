...
export default function DashboardSSOS() {
  ...
  return (
    <div className="p-4 md:p-8 space-y-6 animate-fade-up">
      <DashboardHeader
        title="Dashboard de Solicitações e Ordens de Serviço"
        badge="Engenharia e Manutenção · Operacional"
        description="Acompanhamento operacional de SS, OS e produtividade da equipe técnica."
